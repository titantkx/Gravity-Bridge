...
type IbcAutoSendEthMemo struct {
	SendToEth IbcAutoSendEth `protobuf:"bytes,1,opt,name=send_to_eth,json=sendToEth,proto3" json:"send_to_eth"`
}
...
type IbcAutoSendEth struct {
	...
	BridgeFee      *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=bridge_fee,json=bridgeFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"bridge_fee,omitempty"`
	EvmChainPrefix string                                  `protobuf:"bytes,4,opt,name=evm_chain_prefix,json=evmChainPrefix,proto3" json:"evm_chain_prefix,omitempty"`
}
...
var fileDescriptor_163831c23fcc179f = []byte{
	...
	,
}
