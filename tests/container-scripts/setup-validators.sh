...
# Init genesis for evm chain
mv /edited-genesis.json /evm-chain-genesis.json
jq '.app_state.gravity.evm_chains = [{"evm_chain": {"evm_chain_prefix": "ethereum","evm_chain_name": "ethereum"},"gravity_nonces": {"latest_valset_nonce": "0","last_observed_nonce": "0","last_slashed_valset_nonce": "0","last_slashed_batch_block": "0","last_slashed_logic_call_block": "0","last_tx_pool_id": "0","last_batch_id": "0"},"valsets": [],"valset_confirms": [],"batches": [],"batch_confirms": [],"logic_calls": [],"logic_call_confirms": [],"attestations": [],"delegate_keys": [],"erc20_to_denoms": [],"unbatched_transfers": []}]' /evm-chain-genesis.json >/evm-chain-genesis2.json
jq '.app_state.gravity.params.evm_chain_params = [{"evm_chain_prefix":"ethereum","average_ethereum_block_time":"15000","bridge_active":true,"bridge_chain_id":"15","bridge_ethereum_address":"0x0000000000000000000000000000000000000000","contract_source_hash":"","ethereum_blacklist":[],"gravity_id":"ethereum"}]' /evm-chain-genesis2.json >/edited-genesis.json
