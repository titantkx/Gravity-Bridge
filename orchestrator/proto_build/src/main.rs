...
fn compile_protos(out_dir: &Path, tmp_dir: &Path) {
    ...
    let mut gravity_auction_proto_dir = root.clone();
    gravity_auction_proto_dir.push("module/proto/auction/v1");
    ...
    // Paths
    let proto_paths = [gravity_proto_dir, gravity_auction_proto_dir];
